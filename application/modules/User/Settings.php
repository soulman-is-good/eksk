...
class User_Settings extends X3_Module_Table {
    ...
    public $_fields = array(
        ...
        'mailReport' => array('boolean','default'=>'1'),
        'smsWarning' => array('boolean','default'=>'1'),
        'smsMessages' => array('boolean','default'=>'1'),
        'smsForum' => array('boolean','default'=>'1'),
        'smsVote' => array('boolean','default'=>'1'),
        'smsReport' => array('boolean','default'=>'1'),
        'smsTime' => array('string','default'=>'00:00-00:00'),
        'smsCount' => array('integer[4]','default'=>'5'),
    );
