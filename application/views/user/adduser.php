    ...
    <div class="content">
        ...
        ?>
            ...
            <tr>
                ...
                <td class="field">
                    <div class="wrapper inline-block"><?=X3_Html::form_tag('select',array('class'=>'region_id','id'=>'User_Address_region_id','name'=>'User_Address[region_id]','rid'=>$address->region_id,'fcselect'=>'autocomplete','data-width'=>'345'))?></div>
                </td>
                <td class="error">
